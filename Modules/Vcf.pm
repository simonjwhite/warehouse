...
package Modules::VcfReader;
use base qw(Modules::Vcf);
use strict;
use warnings;
use Carp;
use Data::Dumper;
...
package Modules::Vcf3_2;
use base qw(Modules::VcfReader);
